...
-- AddForeignKey
ALTER TABLE "Signup" ADD CONSTRAINT "Signup_classSessionId_fkey" FOREIGN KEY ("classSessionId") REFERENCES "ClassSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
