...
export default async function CourseCheckoutSuccessPage({
  searchParams,
}: {
  ...
  if (!purchase) {
    return (
      <StatusPage
        ...
        body="If you completed payment, please contact us and we'll get you access."
      />
    );
  }
  ...
  const startHref = course_id
    ? `/courses/${course_id}?token=${purchase.downloadToken}`
    : "/courses";

  return (
    <StatusPage title="Thank you for your purchase!" body="Your course is ready.">
      <a
        href={startHref}
